...
When Decrement == FALSE, there is no difference between the reproductive success of Revealers (Mean = `r round(mean(RS.dFalse.Revealers),2)` children) and Concealers (Mean = `r round(mean(RS.dFalse.Concealers),2)` children), with an effect size of `r round(cohen.d(RS.dFalse.Revealers, RS.dFalse.Concealers, paired = TRUE)$estimate,2)`.
