...
When Decrement == FALSE, there is no significant difference between the reproductive success of Revealers (Mean = `r round(mean(RS.dFalse.Revealers),2)` children) and Concealers (Mean = `r round(mean(RS.dFalse.Concealers),2)` children), with an effect size of `r round(cohen.d(RS.dFalse.Revealers, RS.dFalse.Concealers, paired = TRUE)$estimate,2)`.
...
When Decrement == FALSE, there is no significant difference between the paternal investment of Revealers (Mean = `r round(mean(PI.dFalse.Revealers),0)` units) and Concealers (Mean = `r round(mean(PI.dFalse.Concealers),0)` units), with an effect size of `r round(cohen.d(PI.dFalse.Revealers, PI.dFalse.Concealers, paired = TRUE)$estimate,2)`.
...
When Decrement == TRUE, there is also no significant difference between the reproductive success of Revealers (Mean = `r round(mean(RS.dTrue.Revealers),2)` children) and Concealers (Mean = `r round(mean(RS.dTrue.Concealers),2)` children), with an effect size of `r round(cohen.d(RS.dTrue.Revealers, RS.dTrue.Concealers, paired = TRUE)$estimate,2)`.
...
When Decrement == TRUE, there is also no significant difference between the paternal investment of Revealers (Mean = `r round(mean(PI.dTrue.Revealers),0)` units) and Concealers (Mean = `r round(mean(PI.dTrue.Concealers),0)` units), with an effect size of `r round(cohen.d(PI.dTrue.Revealers, PI.dTrue.Concealers, paired = TRUE)$estimate,2)`.
...
When Decrement == TRUE, there is again a significant difference between the reproductive success of Revealers (Mean = `r round(mean(RS.dTrue.Revealers),2)` children) and Concealers (Mean = `r round(mean(RS.dTrue.Concealers),2)` children), with a large effect size of `r round(cohen.d(RS.dTrue.Revealers, RS.dTrue.Concealers, paired = TRUE)$estimate,2)`.
