---
title: "The Female Aggression Avoidance Hypothesis - Checking Updated Model"
...
```{r}
d <- 
  read.csv('data/ovulationCheckingUpdatedModel.csv', header=T) %>%
  as_tibble() %>%
...
When Decrement == FALSE, there is no significant difference between the reproductive success of Revealers (Mean = `r round(mean(RS.dFalse.Revealers),2)` children) and Concealers (Mean = `r round(mean(RS.dFalse.Concealers),2)` children), with a small effect size of 0.16.
...
When Decrement == TRUE, there is a significant difference between the reproductive success of Revealers (Mean = `r round(mean(RS.dTrue.Revealers),2)` children) and Concealers (Mean = `r round(mean(RS.dTrue.Concealers),2)` children), with a small effect size of -0.49.
...
When Decrement == FALSE, there is no significant difference between the paternal investment of Revealers (Mean = `r round(mean(PI.dFalse.Revealers),0)` units) and Concealers (Mean = `r round(mean(PI.dFalse.Concealers),0)` units), with a small effect size of 0.13.
...
When Decrement == TRUE, there is a significant difference between the paternal investment of Revealers (Mean = `r round(mean(PI.dTrue.Revealers),0)` units) and Concealers (Mean = `r round(mean(PI.dTrue.Concealers),0)` units), with a small effect size of -0.48.
...
When Decrement == FALSE, there is no significant difference between the reproductive success of Revealers (Mean = `r round(mean(RS.dFalse.Revealers),2)` children) and Concealers (Mean = `r round(mean(RS.dFalse.Concealers),2)` children), with a negligible effect size of -0.13.
...
When Decrement == TRUE, there is also no significant difference between the reproductive success of Revealers (Mean = `r round(mean(RS.dTrue.Revealers),2)` children) and Concealers (Mean = `r round(mean(RS.dTrue.Concealers),2)` children), with a negligible effect size of -0.15.
...
When Decrement == FALSE, there is no significant difference between the paternal investment of Revealers (Mean = `r round(mean(PI.dFalse.Revealers),0)` units) and Concealers (Mean = `r round(mean(PI.dFalse.Concealers),0)` units), with a negligible effect size of -0.14.
...
When Decrement == TRUE, there is also no significant difference between the paternal investment of Revealers (Mean = `r round(mean(PI.dTrue.Revealers),0)` units) and Concealers (Mean = `r round(mean(PI.dTrue.Concealers),0)` units), with a negligible effect size of -0.15.
...
When Decrement == FALSE, there is a significant difference between the reproductive success of Revealers (Mean = `r round(mean(RS.dFalse.Revealers),2)` children) and Concealers (Mean = `r round(mean(RS.dFalse.Concealers),2)` children), with a large effect size of -2.79.
...
When Decrement == TRUE, there is again a significant difference between the reproductive success of Revealers (Mean = `r round(mean(RS.dTrue.Revealers),2)` children) and Concealers (Mean = `r round(mean(RS.dTrue.Concealers),2)` children), with a large effect size of -3.05.
...
When Decrement == FALSE, there is a significant difference between the paternal investment of Revealers (Mean = `r round(mean(PI.dFalse.Revealers),0)` units) and Concealers (Mean = `r round(mean(PI.dFalse.Concealers),0)` units), with a large effect size of -2.64.
...
When Decrement == TRUE, there is a significant difference between the paternal investment of Revealers (Mean = `r round(mean(PI.dTrue.Revealers),0)` units) and Concealers (Mean = `r round(mean(PI.dTrue.Concealers),0)` units), with a large effect size of -2.97.
...
ggsave('figures/FigureS6.pdf', plot = p1, width = 180, height = 90, units = 'mm')
ggsave('figures/FigureS6.png', plot = p1, width = 180, height = 90, units = 'mm')
...
ggsave('figures/FigureS7.pdf', plot = p2, width = 180, height = 90, units = 'mm')
ggsave('figures/FigureS7.png', plot = p2, width = 180, height = 90, units = 'mm')
