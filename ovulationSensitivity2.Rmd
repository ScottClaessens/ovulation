...
ggsave('figures/FigureS6.pdf', width = 250, height = 100, units = 'mm')
ggsave('figures/FigureS6.png', width = 250, height = 100, units = 'mm')
...
ggsave('figures/FigureS7.pdf', width = 250, height = 100, units = 'mm')
ggsave('figures/FigureS7.png', width = 250, height = 100, units = 'mm')
...
d %>%
  ...
  summarise(n = n()) %>%
  ggplot(aes(x = strategy, y = n, colour = strategy)) +
...
There do not seem to be consistent differences in amount of aggression between strategies, nor across different model runs.
...
Agents receive around 297 acts of aggression on average, with standard deviation 128.
...
The amount of aggression does not vary across strategies.
...
ggsave('figures/FigureS11.pdf', width = 200, height = 100, units = 'mm')
ggsave('figures/FigureS11.png', width = 200, height = 100, units = 'mm')
```
...
ggsave('figures/FigureS12.pdf', width = 200, height = 100, units = 'mm')
ggsave('figures/FigureS12.png', width = 200, height = 100, units = 'mm')
```
