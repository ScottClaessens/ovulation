...
ggsave(p, filename = 'figures/FigureE4.png', width = 250, height = 300, units = 'mm')
...
ggsave('figures/FigureE7.png', width = 200, height = 100, units = 'mm')
```
...
ggsave('figures/FigureE8.png', width = 200, height = 100, units = 'mm')
```
